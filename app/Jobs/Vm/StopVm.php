...
class StopVm implements ShouldQueue
{
    ...
    //Notification::route('telegram', 5779378630)->notify(new AlertaTelegram("✅ Job finalizado: {$this->taskId}Stop na VM {$this->dados->nome} "));

    Telegram::dispatch("✅ Job finalizado: {$this->taskId}Stop na VM {$this->dados->nome} ");
