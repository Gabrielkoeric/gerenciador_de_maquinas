...
class Rdp implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $colectionName = 'RDSessionCollect';
        $alias = $sistema;
        $displayName = $sistema;
        $filePath = "C:\\escalasoft\\remoteapp\\clientes\\{$apelido}\\{$sistema}.exe";
        $requiredCommandLine = $server . ' ' . $sistema;
