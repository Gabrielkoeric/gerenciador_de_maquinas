...
class ProcessIpAssincrono4 implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $totalLines = count($lines); // Total de linhas do arquivo
        $processedLines = 0; // Inicializa contador de linhas processadas
